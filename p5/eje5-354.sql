...
CREATE TABLE Resultado ( -- Crea la tabla Resultado para almacenar resultados
    Palabra_1 VARCHAR(3999), -- Columna para la primera cadena
    Palabra_2 VARCHAR(3999), -- Columna para la segunda cadena
    Cantidad INT, -- Columna para almacenar la cantidad de operaciones de edición
    PorcentajeDeSimilitud DECIMAL(5, 2) -- Columna para almacenar el porcentaje de similitud
);
...
BEGIN
    ...
    INSERT INTO Resultado (Palabra_1, Palabra_2, Cantidad, PorcentajeDeSimilitud)
...
SELECT CalcularDistanciaYPorcentaje('Rodrigo', 'Rodri');
